...
<body id="grid1">
    ...
    @section('contenido')
    <a href= "like_songs/create" class="btn btn-primary">Crear relacion de gusta usuario</a>
    <a href= "crudmenu" class="btn btn-primary">Volver al menu CRUD</a>
    <table class="table table-dark table-striped mt-4">
        <thead>
            <tr>
                <th scope="col">ID</th>
                <th scope="col">ID de cancion gustada</th>
                <th scope="col">ID de usuarios que gusta cancion</th>
        ...
        <tbody>
            ...
            <tr>
                <td> {{$like_song->id}}</td>
                <td> {{$like_song->id_song}}</td>
                <td> {{$like_song->user_like}}</td>
                <td>
                <form action="like_songs/delete/{{$like_song->id}}" method = "POST">
                        <a href="like_songs/edit/{{$like_song->id}}" class="btn btn-info">Editar relacion</a>
                        @csrf
                        @method('PUT')
