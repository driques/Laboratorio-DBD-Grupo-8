...
<body id="grid1">
    ...
    @section('contenido')
    <a href= "paymentHistories/create" class="btn btn-primary">Crear pago</a>
    ...
    <table class="table table-dark table-striped mt-4">
        <thead>
            <tr>
                ...
                <th scope="col">ID del pagador</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td> {{$payment->user_pay}}</td>
                <td>
                <form action="paymentHistories/delete/{{$payment->id}}" method = "POST">
                        <a href="paymentHistories/edit/{{$payment->id}}" class="btn btn-info">Editar relacion</a>
                        @csrf
                        @method('PUT')
