...
<body id="grid1">
  <script>
    ...
    <table class="table table-dark table-striped mt-4">
        <p style="font-family: 'Roboto', sans-serif; font-size: x-large;">Editar canción</p>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                <form action="/songs/delete/{{$datosCanciones->id}}" method = "POST">
                    <a href="/songs/edit/{{$datosCanciones->id}}" class="btn btn-info">Editar canción</a>
                    @csrf
                    @method('PUT')
                    @if(($datosCanciones->borrado)!=1)
