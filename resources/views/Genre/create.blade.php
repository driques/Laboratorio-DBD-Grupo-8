...
<body id="grid1">
    ...
    @section('contenido')
    <h2>Creacion de genero</h2>
    <form action="/genres/store" method="POST">
        @csrf
        <div class="mb-3">
            <label for="" class="from-label">Nombre genero</label>
            <input id="genre_name" name="genre_name" type="text" class="form-control" tabindex="1" value=""></input>
        </div>
