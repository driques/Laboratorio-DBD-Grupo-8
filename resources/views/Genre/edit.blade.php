...
<body id="grid1">
    ...
    <form method="post" action="{{URL('/genres/update/'.strval($genre->id))}}" >
        @method('put') 
        @csrf
        <div class="form-group">
            <div class="mb-3">
                <label for="" class="from-label">Nombre genero actual</label>
                <input id="codigo" name="genre_name" type="text" class="form-control" tabindex="1" value="{{ $genre->genre_name }}"></input>
            </div>
            <a href="/genres" class="btn btn-secondary" tabindex="5">Cancelar</a>
