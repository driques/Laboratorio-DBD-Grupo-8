...
<div id="grid1">
  ...
  <div style="  text-align: center; ">
    ...
    <h1 style="box-sizing:border-box; display:block; font-size: 80px; text-align: center; color:#bbb; ">Sube tu cancion</h1>
    <div style="  text-align: center; ">
      <a href="/song/register" <button class="btn btn-lg btn-primary rounded-pill">Subir</button>
      </a>
  
      <h1 style="box-sizing:border-box; display:block; font-size: 80px; text-align: center; color:#bbb; ">Ver canciones disponibles</h1>
      <div style="  text-align: center; ">
        <a href="/usersongsrest" <button class="btn btn-lg btn-primary rounded-pill">Ver</button>
        </a>
