...
<body id="grid1">
    ...
    <table class="table table-dark table-striped mt-4">
        ...
        <div class="mb-3">
            <label for="id_genre" class="form-label">Genero</label>

            <form method="GET" action="{{URL('/home/categorySearch')}}"class="mx-1 mx-md-4" method="POST" enctype="multipart/form-data"> 
            <select class="form-select mb-4" aria-label="Seleccione un género:" name="id_genre" >
              @foreach ($category as $category)
              <option value="{{$category->id}}" id="id_genre">{{$category->genre_name}}</option>
              @endforeach
              </select>
