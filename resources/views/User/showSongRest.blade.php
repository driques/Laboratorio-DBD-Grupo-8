                ...
                @foreach($albums as $album)
                    @foreach($genres as $genre)
                        @foreach($songs as $song)
                            @if( auth()->user()->edad > 18 && $song->id_album == $album->id && $song->id_genre == $genre->id && $song->id_artist == $artist->id)
                                <tr>
                                    <td>{{$song->id}}</td>
